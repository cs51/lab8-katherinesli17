...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let new_num = new_id () in
    evt := ({id = new_num ; action = listener} :: !evt) ; new_num ;;
...
let newswire = WEvent.new_event () ;; (* under the hood newswire is = to ref [] *)
...
let fakenews_id = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzzfake_id = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire fakenews_id ;;
WEvent.remove_listener newswire buzzfake_id ;;
